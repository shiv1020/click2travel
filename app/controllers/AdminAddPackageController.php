...
$stmt = $pdo->prepare("
    INSERT INTO packages (name, description, price, duration, image, package_type, travel_mode)
    VALUES (?, ?, ?, ?, ?, ?, ?)
");
$stmt->execute([$name, $description, $price ?: 0, $duration, $imageName, $package_type, $travel_mode]);
